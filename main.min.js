...
!function (t) {
    ...
    t.isOnLine = navigator.onLine, t.http_address = {
        ip: "127.0.0.1",
        port: 8337
    }, t.address_game = {ip: "127.0.0.1", port: 8337}, t.address_test = {
        ip: "127.0.0.1",
        port: 8337
    }, t.address_center = {
        ip: "127.0.0.1",
...
var Main = function (t) {
    function e() {
        ...
        "" == i && is_weixin() && "" == getCookie("wxopenid") && HttpHandler.sendMsgCallBack("http://wx.upniao.com", "APPKEY=2801fc54e260574cbfbea92e91ed3709&notify_url=http://127.0.0.1:8337/notifyWxLogin&return_url=http://127.0.0.1:8337/webplat/index.html", function (t) {
...
var UserDataModel = function () {
    function t() {
        this.bannerList = [], this.ip = "127.0.0.1", this.game_times = 1, this.drop_rate = 0, this.roomCfg = null
    }
...
var HttpServer = function (t) {
    function e() {
        t.call(this), this._pool = [], this._http = new egret.URLLoader,this.headers = 'Access-Control-Allow-Origin', this._http.dataFormat = egret.URLLoaderDataFormat.TEXT, this._http.addEventListener(egret.Event.COMPLETE, this.response, this), this._http.addEventListener(egret.IOErrorEvent.IO_ERROR, this.ioError, this)
    }
...
var SocketClientManager = function (t) {
    ...
    return e.getInstance = function () {
        ...
        var e = {};
        console.log("user uid :"+UserDataModel.getInstance().uid)
        UserDataModel.getInstance().uid
        e.currency = UserDataModel.getInstance().currency,
            e.nickName = UserDataModel.getInstance().nick,
            e.uid = UserDataModel.getInstance().uid,
            e.iconUrl = UserDataModel.getInstance().pic,
            e.sexNum = UserDataModel.getInstance().sexNum,
            e.uname = UserDataModel.getInstance().uname,
            this._socket.emit("enternormalRoom", t, e)
    }, e._instance = null, e
}(egret.EventDispatcher);
