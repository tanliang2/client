...
!function (t) {
    var e = function (e) {
        function n(i, s) {
            void 0 === i && (i = ""), void 0 === s && (s = 0), e.call(this), this._writeMessage = "", this._readMessage = "", this._connected = !1, this._connecting = !1, this._isReadySend = !1, this._bytesWrite = !1, this._type = n.TYPE_STRING, this._connected = !1, this._writeMessage = "", this._readMessage = "", this.socket = new t.ISocket, this.socket.addCallBacks(this.onConnect, this.onClose, this.onSocketData, this.onError, this)
        }

        __extends(n, e);
        var i = __define, s = n, o = s.prototype;
        return o.connect = function (t, e) {
            this._connecting || this._connected || (this._connecting = !0, this.socket.connect(t, e))
        }, o.connectByUrl = function (t) {
        ...
        }, o.writeBytes = function (e, n, i) {
            return void 0 === n && (n = 0), void 0 === i && (i = 0), this._connected ? this._writeByte ? (this._bytesWrite = !0, this._writeByte.writeBytes(e, n, i), void this.flush()) : void t.$warn(3102) : void t.$warn(3101)
        }, o.readBytes = function (e, n, i) {
            return void 0 === n && (n = 0), void 0 === i && (i = 0), this._readByte ? (this._readByte.position = 0, this._readByte.readBytes(e, n, i), void this._readByte.clear()) : void t.$warn(3102)
        }, i(o, "connected", function () {
    ...
    t.WebSocket = e, t.registerClass(e, "egret.WebSocket")
}(egret || (egret = {}));
var egret;
!function (t) {
    var e;
    !function (e) {
        var n = function () {
            ...
            var e = (__define, t), n = e.prototype;
            return n.addCallBacks = function (t, e, n, i, s) {
                this.onConnect = t, this.onClose = e, this.onSocketData = n, this.onError = i, this.thisObject = s
            }, n.connect = function (t, e) {
                this.host = t, this.port = e;
                var n = "ws://" + this.host + ":" + this.port;
                this.socket = new __global.egret_native.WebSocket(n), this._bindEvent()
            }, n.connectByUrl = function (t) {
        ...
        e.NativeSocket = n, t.registerClass(n, "egret.native.NativeSocket", ["egret.ISocket"]), t.Capabilities.runtimeType == t.RuntimeType.NATIVE && (t.ISocket = n)
    }(e = t["native"] || (t["native"] = {}))
}(egret || (egret = {}));
var egret;
!function (t) {
    ...
    !function (e) {
        var n = function () {
            ...
            console.log("init sockt");
            var n = (__define, e), i = n.prototype;
            return i.addCallBacks = function (t, e, n, i, s) {
                this.onConnect = t, this.onClose = e, this.onSocketData = n, this.onError = i, this.thisObject = s
        ...
        e.HTML5WebSocket = n, t.registerClass(n, "egret.web.HTML5WebSocket", ["egret.ISocket"]), t.Capabilities.runtimeType == t.RuntimeType.WEB && (t.ISocket = n)
    }(e = t.web || (t.web = {}))
}(egret || (egret = {}));
