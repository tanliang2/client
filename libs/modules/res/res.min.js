            ...
            if (e) {
                ...
                if (o) for (var u = o.length, n = 0; u > n; n++) {
                    for (var l = o[n], c = [], h = l.keys.split(","), f = h.length, d = 0; f > d; d++) {
                        var g = h[d].trim(), s = this.keyMap[g];
...
!function (e) {
    var t = function (t) {
        ...
        return n.getRes = function (t) {
            ...
            for (var a in i) {
                var o = i[a], u = n.createTexture(a, o.x, o.y, o.w, o.h, o.offX, o.offY, o.sourceW, o.sourceH);
                if (o.scale9grid) {
                    var l = o.scale9grid, c = l.split(",");
...
!function (e) {
    ...
    var m = function (t) {
        ...
        return n.$getAnalyzerByType = function (e) {
            ...
            a.loaded = !1;
            var o = this.$getAnalyzerByType(u), c = o.destroyRes(e);
