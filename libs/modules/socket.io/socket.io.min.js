!function (t) {
    ...
    return function e(t, n, r) {
        ...
        3: [function (t, e, n) {
            ...
            var o = (t("./url"), t("engine.io-client")), i = t("./socket"), s = t("component-emitter"),
                a = t("socket.io-parser"), c = t("./on"), p = t("component-bind"),
                u = (t("object-component"), t("debug")("socket.io-client:manager")), f = t("indexof");
        ...
        5: [function (t, e, n) {
            ...
            i(r.prototype), r.prototype.subEvents = function () {
                ...
                p("close (%s)", t), this.connected = !1, this.disconnected = !0, this.emit("disconnect", t)
        ...
        9: [function (t, e, n) {
            ...
            e.exports = r, r.names = [], r.skips = [], r.enable = function (t) {
                ...
                for (var n = (t || "").split(/[\s,]+/), o = n.length, i = 0; o > i; i++) t = n[i].replace("*", ".*?"), "-" === t[0] ? r.skips.push(new RegExp("^" + t.substr(1) + "$")) : r.names.push(new RegExp("^" + t + "$"))
            }, r.disable = function () {
                r.enable("")
                ...
                for (var e = 0, n = r.skips.length; n > e; e++) if (r.skips[e].test(t)) return !1;
        ...
        16: [function (t, e, n) {
            (function (n) {
                ...
                e.exports = o, e.exports.Request = i, u(o, c), o.prototype.supportsBinary = !0, o.prototype.request = function (t) {
                    ...
                    this.cleanup()
                }, n.document && (i.requestsCount = 0, i.requests = {}, n.attachEvent ? n.attachEvent("onunload", s) : n.addEventListener && n.addEventListener("beforeunload", s))
            }).call(this, "undefined" != typeof self ? self : "undefined" != typeof window ? window : {})
        ...
        17: [function (t, e, n) {
            ...
            var o = t("../transport"), i = t("parseqs"), s = t("engine.io-parser"), a = t("component-inherit"),
        ...
        18: [function (t, e, n) {
            ...
            var o = t("../transport"), i = t("engine.io-parser"), s = t("parseqs"), a = t("component-inherit"),
                c = t("debug")("engine.io-client:websocket"), p = t("ws");
            e.exports = r, a(r, o), r.prototype.name = "websocket", r.prototype.supportsBinary = !0, r.prototype.doOpen = function () {
                if (this.check()) {
                    ...
                    this.ws = new p(t, e, n), void 0 === this.ws.binaryType && (this.supportsBinary = !1), this.ws.binaryType = "arraybuffer", this.addEventListeners()
                }
                ...
                var n = this;
                this.writable = !1;
                for (var r = 0, o = t.length; o > r; r++) i.encodePacket(t[r], this.supportsBinary, function (t) {
                    try {
                        n.ws.send(t)
                    } catch (e) {
        ...
        21: [function (t, e, n) {
            (function (e) {
                ...
                var a = t("./keys"), c = t("arraybuffer.slice"), p = t("base64-arraybuffer"), u = t("after"),
                    f = t("utf8"), h = navigator.userAgent.match(/Android/i);
                n.protocol = 3;
                var l = n.packets = {open: 0, close: 1, ping: 2, pong: 3, message: 4, upgrade: 5, noop: 6}, d = a(l),
                    y = {type: "error", data: "parser error"}, g = t("blob");
                n.encodePacket = function (t, n, o, s) {
                    ...
                    for (var o = t, i = [], s = !1; o.byteLength > 0;) {
                        for (var a = new Uint8Array(o), p = 0 === a[0], u = "", f = 1; 255 != a[f]; f++) {
                            if (u.length > 310) {
                                s = !0;
                                break
                            }
            ...
            (function (e) {
                !function (o) {
                    ...
                    if ("function" == typeof t && "object" == typeof t.amd && t.amd) t(function () {
                        ...
                        for (var B in w) A.call(w, B) && (l[B] = w[B])
                    } else o.utf8 = w
                }(this)
            }).call(this, "undefined" != typeof self ? self : "undefined" != typeof window ? window : {})
        }, {}],
        ...
        43: [function (e, n, r) {
            !function (e) {
                ...
                if (!n("json")) {
                    ...
                    var B = {"boolean": 1, number: 1, string: 1, undefined: 1}, x = function (t, e) {
                        var n = typeof t[e];
                    ...
                    if (i = function (t, e) {
                        ...
                        return n = r = null, c ? i = 2 == c ? function (t, e) {
                            ...
                            var n, i, s = a.call(t) == l,
                                c = !s && "function" != typeof t.constructor && x(t, "hasOwnProperty") ? t.hasOwnProperty : o;
                        ...
                        var C = {92: "\\\\", 34: '\\"', 8: "\\b", 12: "\\f", 10: "\\n", 13: "\\r", 9: "\\t"},
                            S = "000000", E = function (t, e) {
                                ...
                                return n + '"'
                            }, P = function (t, e, n, r, c, p, u) {
                                var f, h, l, b, k, B, x, C, S, T, R, N, O, j, q, D;
                                try {
                                    f = e[t]
                                } catch (U) {
                                }
                                if ("object" == typeof f && f) if (h = a.call(f), h != d || o.call(f, "toJSON")) "function" == typeof f.toJSON && (h != y && h != g && h != m || o.call(f, "toJSON")) && (f = f.toJSON(t)); else if (f > -1 / 0 && 1 / 0 > f) {
                                    if (A) {
                                        ...
                                        k = 1 + k - A(l, b), B = (f % 864e5 + 864e5) % 864e5, x = w(B / 36e5) % 24, C = w(B / 6e4) % 60, S = w(B / 1e3) % 60, T = B % 1e3
                                    } else l = f.getUTCFullYear(), b = f.getUTCMonth(), k = f.getUTCDate(), x = f.getUTCHours(), C = f.getUTCMinutes(), S = f.getUTCSeconds(), T = f.getUTCMilliseconds();
                                    f = (0 >= l || l >= 1e4 ? (0 > l ? "-" : "+") + E(6, 0 > l ? -l : l) : E(4, l)) + "-" + E(2, b + 1) + "-" + E(2, k) + "T" + E(2, x) + ":" + E(2, C) + ":" + E(2, S) + "." + E(3, T) + "Z"
                                } else f = null;
                                ...
                                if (h == g) return _("" + f);
                                if ("object" == typeof f) {
                                    for (j = u.length; j--;) if (u[j] === f) throw TypeError();
                                    if (u.push(f), R = [], q = p, p += c, h == m) {
                                        for (O = 0, j = f.length; j > O; O++) N = P(O, f, n, r, c, p, u), R.push(N === s ? "null" : N);
                                        D = R.length ? c ? "[\n" + p + R.join(",\n" + p) + "\n" + q + "]" : "[" + R.join(",") + "]" : "[]"
                                    } else i(r || f, function (t) {
                                        var e = P(t, f, n, r, c, p, u);
                                        e !== s && R.push(_(t) + ":" + (c ? " " : "") + e)
                                    }), D = R.length ? c ? "{\n" + p + R.join(",\n" + p) + "\n" + q + "}" : "{" + R.join(",") + "}" : "{}";
                                    return u.pop(), D
                                }
                    ...
                    if (!n("json-parse")) {
                        var R, N, O = String.fromCharCode,
                            j = {92: "\\", 34: '"', 47: "/", 98: "\b", 116: "	", 110: "\n", 102: "\f", 114: "\r"},
                            q = function () {
                                throw R = N = null, SyntaxError()
                            }, D = function () {
                                for (var t, e, n, r, o, i = N, s = i.length; s > R;) switch (o = i.charCodeAt(R)) {
                                    case 9:
                                    case 10:
                                    case 13:
                                    case 32:
                                    ...
                                    case 34:
                                        for (t = "@", R++; s > R;) if (o = i.charCodeAt(R), 32 > o) q(); else if (92 == o) switch (o = i.charCodeAt(++R)) {
                                            case 92:
                                            case 34:
                                            case 47:
                                            case 98:
                                            ...
                                            case 114:
                                                ...
                                                break;
                                            case 117:
                                                for (e = ++R, n = R + 4; n > R; R++) o = i.charCodeAt(R), o >= 48 && 57 >= o || o >= 97 && 102 >= o || o >= 65 && 70 >= o || q();
                                                t += O("0x" + i.slice(e, R));
                                                break;
                                            default:
                                                q()
                                    ...
                                    default:
                                        if (e = R, 45 == o && (r = !0, o = i.charCodeAt(++R)), o >= 48 && 57 >= o) {
                                            for (48 == o && (o = i.charCodeAt(R + 1), o >= 48 && 57 >= o) && q(), r = !1; s > R && (o = i.charCodeAt(R), o >= 48 && 57 >= o); R++) ;
                                        ...
                                        if (r && q(), "true" == i.slice(R, R + 4)) return R += 4, !0;
                        ...
                        u.parse = function (t, e) {
                            var n, r;
                            return R = 0, N = "" + t, n = U(D()), "$" != D() && q(), R = N = null, e && a.call(e) == l ? L((r = {}, r[""] = n, r), "", e) : n
                        }
                    }
                }
                c && t(function () {
