    ...
    var e = [], i = function (i) {
        ...
        return s.$getEventMap = function (t) {
            ...
            for (var o = -1, h = t.length, l = 0; h > l; l++) {
                ...
                -1 == o && u.priority < s && (o = l)
            }
            var c = {type: e, listener: i, thisObject: n, priority: s, target: this, useCapture: r, dispatchOnce: !!a};
...
!function (t) {
    ...
    var i = function (i) {
        ...
        return a.$setFlags = function (t) {
            ...
            void 0 === i && (i = !0);
            var n = this, r = n.$DisplayObject, s = r[6];
            ...
            if (e == t.DirtyRegionPolicy.OFF) {
                ...
                var a = n.$displayList || n.$parentDisplayList, u = r.renderRegion;
            ...
            if (n) {
                var r = this.$getInvertedConcatenatedMatrix(), s = r.a * e + r.c * i + r.tx,
                    a = r.b * e + r.d * i + r.ty, o = void 0, h = this.$displayList;
                if (h) {
            ...
            var r = this.$getInvertedConcatenatedMatrix(), f = this.getBounds(null, !1), s = r.a * e + r.c * i + r.tx,
                a = r.b * e + r.d * i + r.ty;
            if (f.contains(s, a)) {
...
!function (t) {
    var e = function (e) {
        ...
        return s.$onAddToStage = function (i, n) {
            ...
            var e = this.$Bitmap;
            if (e[1]) {
                var i = this.$Bitmap, n = isNaN(i[11]) ? i[8] : i[11], r = isNaN(i[12]) ? i[9] : i[12];
                t.setTo(0, 0, n, r)
            } else {
                var n = isNaN(e[11]) ? 0 : e[11], r = isNaN(e[12]) ? 0 : e[12];
                t.setTo(0, 0, n, r)
            }
        }, s.$render = function () {
            var e = this.$Bitmap;
            if (e[1]) {
                var i = isNaN(e[11]) ? e[8] : e[11], n = isNaN(e[12]) ? e[9] : e[12];
            ...
            var n, r = this.$getInvertedConcatenatedMatrix(), s = r.a * e + r.c * i + r.tx,
                a = r.b * e + r.d * i + r.ty, o = this.$displayList;
            if (o) {
...
!function (t) {
    var e = function (e) {
        ...
        return s.$propagateFlagsDown = function (t) {
            ...
            var n = this.$getInvertedConcatenatedMatrix(), r = n.a * t + n.c * i + n.tx, s = n.b * t + n.d * i + n.ty,
...
!function (t) {
    ...
    var i = function (i) {
        ...
        return s.$setTarget = function (t) {
            ...
            var r = this.fillPath, s = this.strokePath;
            ...
            var h = .5 * r | 0, l = s ? .5 * s | 0 : h, u = t + i, c = e + n, d = c - l;
            ...
            t = +t || 0, e = +e || 0, i = +i || 0;
            var n = this.fillPath, r = this.strokePath;
            ...
            if (!(0 > n || r === s)) {
                ...
                var o = this.fillPath, h = this.strokePath;
                ...
                var l = t + Math.cos(s) * n, u = i + Math.sin(s) * n;
            ...
            var n = this.targetDisplay, r = n.$getInvertedConcatenatedMatrix(), s = r.a * e + r.c * i + r.tx,
                a = r.b * e + r.d * i + r.ty, o = t.sys.canvasHitTestBuffer;
            o.resize(3, 3);
    ...
    var e = function (e) {
        ...
        return r.$render = function () {
            ...
            if (i) {
                ...
                var r = isNaN(e[11]) ? e[8] : e[11], s = isNaN(e[12]) ? e[9] : e[12], a = r / e[8], o = s / e[9],
                    h = e[4], l = e[5];
...
!function (t) {
    ...
    var e = function (e) {
        ...
        return n(s, "textureWidth", function () {
            ...
            this._bitmapData = e;
            var i = t.$TextureScaleFactor, n = e.width * i, r = e.height * i;
...
!function (t) {
    var e = function (e) {
        ...
        return r.drawToTexture = function (e, i, n) {
            ...
            var s = (r.x + r.width) * n, a = (r.y + r.height) * n;
...
!function (t) {
    var e = function (e) {
        ...
        return n(s, "graphics", function () {
            ...
            if (!this.$visible) return null;
            var n = this.$getInvertedConcatenatedMatrix(), r = n.a * e + n.c * i + n.tx, s = n.b * e + n.d * i + n.ty,
                a = this.$scrollRect ? this.$scrollRect : this.$maskRect;
            if (a && !a.contains(r, s)) return null;
...
!function (t) {
    var e = function (t) {
        ...
        return i(r, "matrix", function () {
            ...
            if (t) for (var e = 0; 20 > e; e++) this.$matrix[e] = t[e]; else for (var e = 0; 20 > e; e++) this.$matrix[e] = 0 == e || 6 == e || 12 == e || 18 == e ? 1 : 0
        }, r.$toJson = function () {
...
var egret;
!function (t) {
    var e = Math.PI, i = 2 * e, n = e / 180, r = [], s = function (s) {
        ...
        return a.release = function (t) {
            ...
            if (e = +e, 0 !== e) {
                e /= n;
                var i = t.NumberUtils.cos(e), r = t.NumberUtils.sin(e), s = this.a, a = this.b, o = this.c, h = this.d,
                    l = this.tx, u = this.ty;
            ...
            if (0 !== r) {
                r /= n;
                var h = t.NumberUtils.cos(r), l = t.NumberUtils.sin(r);
            ...
            var e = this.a, i = this.b, n = this.c, r = this.d, s = this.tx, a = this.ty, o = t.x, h = t.y,
                l = o + t.width, u = h + t.height, c = e * o + n * h + s, d = i * o + r * h + a, f = e * l + n * h + s,
                g = i * l + r * h + a, p = e * l + n * u + s, v = i * l + r * u + a, $ = e * o + n * u + s,
                m = i * o + r * u + a, y = 0;
            ...
            s /= n, a /= n;
            var o = t.NumberUtils.cos(s), h = t.NumberUtils.sin(s);
            ...
            var i = t.a * this.a, n = 0, r = 0, s = t.d * this.d, a = t.tx * this.a + this.tx,
    ...
    !function (e) {
        function i(t, e) {
            var i = t.minX < e.minX ? t.minX : e.minX, n = t.minY < e.minY ? t.minY : e.minY,
                r = t.maxX > e.maxX ? t.maxX : e.maxX, s = t.maxY > e.maxY ? t.maxY : e.maxY;
            return (r - i) * (s - n)
        }
    ...
    !function (e) {
        var i = function (i) {
            ...
            return n.create = function (i) {
                ...
                if (null == i) return !1;
                i.$removeFlagsUp(768);
                var n = this.$renderNode, r = i.$getConcatenatedMatrix();
                if (e == t.DirtyRegionPolicy.OFF) {
                    ...
                    var h = i.$getOriginalBounds(), s = i.$parentDisplayList, l = n.renderRegion;
                ...
                if (n && n.length > 0) {
                    ...
                    if (r.beginClip(this.dirtyList, this.offsetX, this.offsetY), n = this.$dirtyRegionPolicy == t.DirtyRegionPolicy.OFF ? null : this.dirtyList, i = e.systemRenderer.render(this.root, r, this.offsetMatrix, n), r.endClip(), !this.isStage) {
                        var s = r.surface, a = this.$renderNode;
                        a.drawData.length = 0;
                        var o = s.width, h = s.height;
                ...
                var n = this.renderBuffer, r = Math.max(257, i.width), s = Math.max(257, i.height);
    ...
    !function (e) {
        function i(i, n, r, s) {
            if (n && (t.log = function () {
                ...
                var o = void 0 === s.x ? 0 : s.x, c = void 0 === s.y ? 0 : s.y;
        ...
        function r(t) {
            ...
            var a = this.screenDisplayList.renderBuffer, o = a.context;
    ...
    !function (e) {
        var i = [], n = function () {
            ...
            return t.release = function (t) {
                ...
                var i, n, r, s, a = e, o = a.a, h = a.b, l = a.c, u = a.d, c = a.tx, d = a.ty, f = t.x, g = t.y,
                    p = f + t.width, v = g + t.height;
                if (1 == o && 0 == h && 0 == l && 1 == u) i = f + c - 1, n = g + d - 1, r = p + c + 1, s = v + d + 1; else {
                    var $ = o * f + l * g + c, m = h * f + u * g + d, y = o * p + l * g + c, T = h * p + u * g + d,
                        x = o * p + l * v + c, b = h * p + u * v + d, _ = o * f + l * v + c, E = h * f + u * v + d,
                        C = 0;
    ...
    !function (e) {
        var i = function (e) {
            ...
            return r.calculateStageSize = function (e, i, n, r, s) {
                var a = i, o = n, h = r, l = s, u = i / h || 0, c = n / l || 0;
                switch (e) {
    ...
    !function (e) {
        ...
        var i = function () {
            ...
            return r.$addPlayer = function (t) {
                ...
                var i = t.getTimer(), n = this.callBackList, r = this.thisObjectList, s = n.length,
                    a = e.$requestRenderingFlag, o = t.getTimer();
                this.callLaterAsyncs();
                for (var h = 0; s > h; h++) n[h].call(r[h], o) && (a = !0);
                var l = t.getTimer(), u = o - this.lastTimeStamp;
                if (this.lastTimeStamp = o, u >= this.frameDeltaTime) this.lastCount = this.frameInterval; else {
        ...
        var i = function (e) {
            ...
            return r.drawImage = function (t, e, i, n, r, s, a, o) {
                ...
                if (n) {
                    ...
                    if (e.smoothing = m, e.image = n, e.imageWidth = g, e.imageHeight = p, v) i.$updateTextureDataWithScale9Grid(e, v, r, s, a, o, h, l, u, c, d, f); else if ($ == t.BitmapFillMode.SCALE) {
                        var T = d / u * y, x = f / c * y;
                        e.drawImage(r, s, a, o, h, l, T * a, x * o)
                    } else if ($ == t.BitmapFillMode.CLIP) {
                        var b = Math.min(u, d), _ = Math.min(c, f), E = a * y, C = o * y;
                        i.drawClipImage(e, y, r, s, E, C, h, l, b, _)
                    } else for (var E = a * y, C = o * y, F = 0; d > F; F += u) for (var w = 0; f > w; w += c) {
                        var b = Math.min(d - F, u), _ = Math.min(f - w, c);
                ...
                var p = i.x - o, v = i.y - h, $ = p / t.$TextureScaleFactor, m = v / t.$TextureScaleFactor,
                    y = i.width / t.$TextureScaleFactor, T = i.height / t.$TextureScaleFactor;
                0 == T && (T = 1, m >= g && m--), 0 == y && (y = 1, $ >= f && $--);
                var x = n, b = x + $, _ = b + y, E = f - $ - y, C = r, F = C + m, w = F + T, R = g - m - T,
                    S = E * t.$TextureScaleFactor, D = R * t.$TextureScaleFactor;
                if (($ + E) * t.$TextureScaleFactor > c || (m + R) * t.$TextureScaleFactor > d) return void e.drawImage(n, r, s, a, o, h, c, d);
                var O = o, L = O + p, M = O + (c - S), A = c - p - S, N = h, I = N + v, B = N + d - D, P = d - v - D;
...
!function (t) {
    var e;
    !function (e) {
        var i = ["none", "round", "square"], n = ["bevel", "miter", "round"], r = function (r) {
            function s() {
                r.call(this), this.dirtyRender = !0, this.type = 3
            }

            __extends(s, r);
            var a = s, o = a.prototype;
    ...
    !function (e) {
        var i = function () {
            ...
            return i.moveTo = function (t, e) {
                ...
                var u = t + i, c = e + n, d = t + a, f = u - a, g = e + o, p = c - o;
                ...
                for (var d = Math.cos(h), f = Math.sin(h), g = 0; 4 > g; g++) {
                    var p = l - h, v = 4 * Math.tan(p / 4) / 3, $ = u - f * v * i, m = c + d * v * n;
                    d = Math.cos(l), f = Math.sin(l), u = t + d * i, c = e + f * n;
                    var y = u + f * v * i, T = c - d * v * n;
...
!function (t) {
    function e(t, e) {
        var i = null == e.italic ? t.italic : e.italic, n = null == e.bold ? t.bold : e.bold,
            r = null == e.size ? t.size : e.size, s = e.fontFamily || t.fontFamily, a = i ? "italic " : "normal ";
        return a += n ? "bold " : "normal ", a += r + "px " + s
    }

    function i(t, e) {
        var i = t >> 16, n = t >> 8 & 255, r = 255 & t;
        return "rgba(" + i + "," + n + "," + r + "," + e + ")"
    }
    ...
    function r(t, e, i, n) {
        for (var r = n[0], s = n[1], a = n[2], o = n[3], h = n[4], l = n[5], u = n[6], c = n[7], d = n[8], f = n[9], g = n[10], p = n[11], v = n[12], $ = n[13], m = n[14], y = n[15], T = n[16], x = n[17], b = n[18], _ = n[19], E = 0, C = e * i * 4; C > E; E += 4) {
            var F = t[E + 0], w = t[E + 1], R = t[E + 2], S = t[E + 3];
    ...
    function d(t, e) {
        for (var i = 0, n = t.length; n > i; i += 4) {
            var r = t[i + 0], s = t[i + 1], a = t[i + 2], o = t[i + 3] / 255, h = e[i + 0], l = e[i + 1], u = e[i + 2],
                c = e[i + 3] / 255;
    ...
    function g(t, e, i, n, r, s, a, o, h, l, u, c) {
        for (var d, g, p = new Uint8ClampedArray(t), v = n[3], $ = 0, m = 0, y = o * Math.cos(a), T = o * Math.sin(a), x = 7, b = 12, _ = 3.141592653589793, E = r / x, C = s / x, F = 0; e > F; F++) for (var w = 0; i > w; w++) {
            for (var R = 0, S = w * e * 4 + 4 * F, D = 0, O = 0, L = t[S + 0] / 255, M = t[S + 1] / 255, A = t[S + 2] / 255, N = t[S + 3] / 255, I = 0; 2 * _ >= I; I += 2 * _ / b) {
                ...
                for (var B = 0; x > B; B++) {
                    $ = B * E * d, m = B * C * g;
                    var P = Math.round(F + $ - y), k = Math.round(w + m - T), U = 0;
                    if (P >= e || 0 > P || 0 > k || k >= i) U = 0; else {
                        var X = k * e * 4 + 4 * P;
                        U = t[X + 3] / 255
                    }
                    D += (x - B) * U, O += x - B
            ...
            N = Math.max(N, 1e-4);
            var Y = D / O * h * v * (1 - l) * Math.max(Math.min(c, u), 1 - N), H = (O - D) / O * h * v * l * N;
            N = Math.max(N * u * (1 - c), 1e-4);
            var j = H / (H + N), W = f(L, n[0], j), G = f(M, n[1], j), V = f(A, n[2], j), z = Y / (H + N + Y),
                Z = f(W, n[0], z), q = f(G, n[1], z), J = f(V, n[2], z), K = Math.min(N + Y + H, 1);
            p[S + 0] = 255 * Z, p[S + 1] = 255 * q, p[S + 2] = 255 * J, p[S + 3] = 255 * K
        }
        t.set(p)
    }

    var p = ["source-over", "lighter", "destination-out"], v = "source-over", $ = "#000000",
        m = {none: "butt", square: "square", round: "round"}, y = [], T = function () {
            function a() {
                this.nestLevel = 0, this.renderingMask = !1
            }

            var o = a, l = o.prototype;
            return l.render = function (t, e, i, n, r) {
                this.nestLevel++;
                var s = e.context, a = r ? t : null, o = this.drawDisplayObject(t, s, n, i, null, null, a);
                ...
                if (s && !o ? (s.isDirty && (l += s.drawToSurface()), h = s.$renderNode) : h = e.$getRenderNode(), h) {
                    if (n) {
                        ...
                        if (a && !a.intersects(u)) h.needRedraw = !1; else if (!h.needRedraw) for (var c = n.length, d = 0; c > d; d++) if (u.intersects(n[d])) {
                            h.needRedraw = !0;
                            break
                        }
                    } else h.needRedraw = !0;
                ...
                if (t.Capabilities.runtimeType == t.RuntimeType.NATIVE) {
                    var u, c = 0, d = e.$getFilters(), f = 0 !== e.$blendMode;
                ...
                var _, E = 0, C = e.$getFilters(), F = C.length, w = 0 !== e.$blendMode;
                ...
                S.updateRegion(D, R);
                var O = this.createRenderBuffer(S.width, S.height), L = O.context;
                ...
                if (E += e.$mask && (e.$mask.$parentDisplayList || l) ? this.drawWithClip(e, L, n, M, S, l) : e.$scrollRect || e.$maskRect ? this.drawWithScrollRect(e, L, n, M, S, l) : this.drawDisplayObject(e, L, n, M, e.$displayList, S, l), t.Matrix.release(M), E > 0) {
                    ...
                    for (var A = L.getImageData(0, 0, O.surface.width, O.surface.height), N = 0; F > N; N++) {
                        var I = C[N];
                        if ("colorTransform" == I.type) r(A.data, O.surface.width, O.surface.height, I.$matrix); else if ("blur" == I.type) s(A.data, O.surface.width, O.surface.height, I.$blurX, I.$blurY); else if ("glow" == I.type) {
                            var B = I.$red, P = I.$green, k = I.$blue, U = I.$alpha;
                ...
                var o, h = 0, l = 0 !== e.$blendMode;
                l && (o = p[e.$blendMode], o || (o = v));
                var u, c = e.$scrollRect ? e.$scrollRect : e.$maskRect, d = e.$mask;
                ...
                var w = this.createRenderBuffer(b.width, b.height), R = w.context;
                ...
                if (h += this.drawDisplayObject(e, R, n, S, e.$displayList, b, a), d) if (t.Capabilities.$runtimeType == t.RuntimeType.WEB && u && 1 == u.$getRenderCount() || d.$displayList) R.globalCompositeOperation = "destination-in", h += this.drawDisplayObject(d, R, n, S, d.$displayList, b, a); else {
                    var D = this.createRenderBuffer(b.width, b.height), O = D.context;
                ...
                if (h.isEmpty() || c.updateRegion(h, l), c.isEmpty() || s && !s.intersects(c)) return t.sys.Region.release(c), t.Matrix.release(l), o;
                var d = !1;
                if (n) {
                ...
                var n = e.image, r = e.drawData, s = r.length, a = 0, o = e.matrix;
                ...
                var s = e.drawData, a = s.length, o = 0, h = e.matrix, l = e.blendMode, u = e.alpha, c = !1;
                ...
                if (g && 8 == a) if (t.Capabilities.runtimeType == t.RuntimeType.NATIVE) {
                    ...
                    var $ = this.createRenderBuffer(s[6], s[7]), m = $.context;
...
!function (t) {
    var e = function (e) {
        ...
        return n(s, "smoothing", function () {
            ...
            var e = this.$BitmapText, n = this.$getTextLines(), r = n.length;
            if (0 != r) {
                var s = this.$textLinesWidth, a = e[5], o = this.$renderNode;
                ...
                for (var h = a._getFirstCharHeight(), l = Math.ceil(h * i.EMPTY_FACTOR), u = !isNaN(e[1]), c = e[8], d = e[0], f = e[1], g = e[10], p = this.$textOffsetY + this.$textStartY, v = this.$lineHeights, $ = 0; r > $; $++) {
                    var m = v[$];
                    if (u && $ > 0 && p + m > f) break;
                    var y = n[$], T = y.length, x = this.$textOffsetX;
                    if (g != t.HorizontalAlign.LEFT) {
                        var b = d > c ? d : c;
                        g == t.HorizontalAlign.RIGHT ? x += b - s[$] : g == t.HorizontalAlign.CENTER && (x += Math.floor((b - s[$]) / 2))
                    }
                    for (var _ = 0; T > _; _++) {
                        var E = y.charAt(_), C = a.getTexture(E);
                        if (C) {
                            var F = C._bitmapWidth, w = C._bitmapHeight;
            ...
            for (var o, h, l, u, c = n[3], d = n[4], f = 0, g = 0, p = 0, v = 0, $ = !isNaN(n[0]), m = n[0], y = n[1], T = n[5], x = T._getFirstCharHeight(), b = Math.ceil(x * i.EMPTY_FACTOR), _ = n[2], E = _.split(/(?:\r\n|\r|\n)/), C = E.length, F = !0, w = 0; C > w; w++) {
                var R = E[w], S = R.length;
                l = 0, u = 0, o = !0, h = !1;
                for (var D = 0; S > D; D++) {
                    o || (u += d);
                    var O = R.charAt(D), L = void 0, M = void 0, A = 0, N = 0, I = T.getTexture(O);
                    if (I) L = I.$getTextureWidth(), M = I.$getTextureHeight(), A = I._offsetX, N = I._offsetY; else {
                        if (" " != O) {
                            t.$warn(1046, O), o && (o = !1);
                            continue
                        }
...
!function (t) {
    var e = function (e) {
        ...
        return r.init = function (e) {
            ...
            var i, n, r = this._text.$TextField, s = this.stageText.$getText(), a = !1;
...
!function (t) {
    function e(e, i, r) {
        r = r || {};
        var s = null == r.italic ? i[16] : r.italic, a = null == r.bold ? i[15] : r.bold,
            o = null == r.size ? i[0] : r.size, h = r.fontFamily || i[8] || n.default_fontFamily;
    ...
    var i = new RegExp("(?=[\\u00BF-\\u1FFF\\u2C00-\\uD7FF]|\\b|\\s)(?![。，！、》…）)}”】\\.\\,\\!\\?\\]\\:])"),
        n = function (n) {
            ...
            return o.isInput = function () {
                ...
                var r = this.$getRenderBounds(), s = n.prototype.$update.call(this, e, r);
                ...
                var i = this.$getRenderBounds(), n = this.textNode;
                        ...
                        for (var p = g.text.toString(), v = p.split(/(?:\r\n|\r|\n)/), $ = 0, m = v.length; m > $; $++) {
                            ...
                            if ("" == v[$]) $ == m - 1 && (y = !1); else {
                                ...
                                if (isNaN(s)) h += T, l += v[$].length, a.elements.push({
                                    ...
                                    text: v[$],
                                    style: g.style
                                }), $ == m - 1 && (y = !1); else if (s >= h + T) a.elements.push({
                                    width: T,
                                    text: v[$],
                                    style: g.style
                                }), h += T, l += v[$].length, $ == m - 1 && (y = !1); else {
                                    var x = 0, b = 0, _ = v[$], E = void 0;
                                    E = n[19] ? _.split(i) : _.match(/./g);
                                    for (var C = E.length, F = 0; C > x; x++) {
                                        var w = E[x].length, R = !1;
                                        if (1 == w && C - 1 > x) {
                                            var S = E[x].charCodeAt(0), D = E[x + 1].charCodeAt(0);
                                        ...
                                        if (b + T > s) for (var L = E[x].match(/./g), M = 0, A = L.length; A > M; M++) {
                                            var w = L[M].length, N = !1;
                                            if (1 == w && A - 1 > M) {
                                                var S = L[M].charCodeAt(0), D = L[M + 1].charCodeAt(0);
                                                if (S >= 55296 && 56319 >= S && 56320 == (64512 & D)) {
                                                    var O = L[M] + L[M + 1];
                                    ...
                                    if (x > 0) {
                                        a.elements.push({width: b, text: _.substring(0, F), style: g.style});
                                        var I = _.substring(F), B = void 0, P = I.length;
                ...
                if (0 == i[5]) return [];
                var s = isNaN(i[3]) ? i[5] : i[3], a = t.TextFieldUtils.$getTextHeight(this), o = 0,
                ...
                for (var c = t.TextFieldUtils.$getHalign(this), d = 0, f = [], g = h, p = i[29]; p > g; g++) {
                    ...
                    for (var m = 0, y = v.elements.length; y > m; m++) {
                        var T = v.elements[m], x = T.style.size || i[0];
...
!function (t) {
    var e = function () {
        ...
        return e.$getStartLine = function (t) {
            ...
            if (0 == s) return null;
            var g = r[s - 1], p = t.$TextField[3];
            isNaN(p) && (p = t.textWidth);
            var v = e.$getHalign(t);
            i -= v * (p - g.width);
            for (var $ = 0, d = 0; d < g.elements.length; d++) {
                var m = g.elements[d];
                if ($ + m.width <= i) $ += m.width; else if (i > $) return {lineIndex: s - 1, textElementIndex: d}
            }
            return null
...
!function (t) {
    var e = function () {
        ...
        return t.isNumber = function (t) {
            ...
            var i = Math.floor(e), n = i + 1, r = t.sinInt(i);
            if (i == e) return r;
            var s = t.sinInt(n);
            return (e - i) * s + (n - e) * r
        }, t.sinInt = function (t) {
            ...
            var i = Math.floor(e), n = i + 1, r = t.cosInt(i);
            if (i == e) return r;
            var s = t.cosInt(n);
            return (e - i) * s + (n - e) * r
        }, t.cosInt = function (t) {
...
!function (t) {
    function e(t) {
        ...
        var n = i.constructor.toString().trim(), r = n.indexOf("("), s = n.substring(9, r);
...
!function (t) {
    var e = function () {
        ...
        return e.compileProgram = function (i, n, r) {
            var s = e.compileFragmentShader(i, r), a = e.compileVertexShader(i, n), o = i.createProgram();
