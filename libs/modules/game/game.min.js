...
!function (t) {
    var e = function (e) {
        ...
        return r(n, "smoothing", function () {
            ...
            if (e) {
                var i = Math.round(this.offsetPoint.x), r = Math.round(this.offsetPoint.y), s = e._bitmapWidth,
                    n = e._bitmapHeight, o = e.$getTextureWidth(), a = e.$getTextureHeight(),
                    h = Math.round(e.$getScaleBitmapWidth()), l = Math.round(e.$getScaleBitmapHeight()),
                    c = e._sourceWidth, u = e._sourceHeight;
    ...
    var i = function (e) {
        ...
        return i.get = function (t, e, r, s) {
            ...
            if (this.position = this._prevPos = i, this._prevPosition = t, this._target) if (r) this._updateTargetProps(null, 1); else if (this._steps.length > 0) {
                var n = void 0, o = this._steps.length;
    ...
    var e = function (e) {
        ...
        return r(n, "bounces", function () {
            ...
            if (this._ScrV_Props_._lastTouchPosition.x != t.stageX || this._ScrV_Props_._lastTouchPosition.y != t.stageY) {
                if (!this._ScrV_Props_._scrollStarted) {
                    var e = t.stageX - this._ScrV_Props_._touchStartPosition.x,
                        i = t.stageY - this._ScrV_Props_._touchStartPosition.y, r = Math.sqrt(e * e + i * i);
            ...
            if (0 != this._ScrV_Props_._velocitys.length) {
                ...
                var o = t.x / e * this.scrollSpeed, a = t.y / e * this.scrollSpeed, h = Math.abs(o), l = Math.abs(a),
                    c = this.getMaxScrollLeft(), u = this.getMaxScrollTop(),
