...
!function (t) {
    var e = function (e) {
        ...
        __extends(n, e);
        var i = (__define, n), s = i.prototype;
        return n.get = function (t, e, i, s) {
            ...
            if (i) s && (s.tween_count = s.tween_count > 0 ? s.tween_count + 1 : 1), r.push(e), n._inited || (n._lastTime = t.getTimer(), t.sys.$ticker.$startTick(n.tick, null), n._inited = !0); else {
                s && s.tween_count--;
            ...
            if (this.position = this._prevPos = n, this._prevPosition = t, this._target && this._steps.length > 0) {
                ...
                for (var o = 0; r > o; o++) if ("action" == this._steps[o].type) 0 != e && (this._useTicks ? this._runAction(this._steps[o], n, n) : 1 == e && s > n ? (s != this.duration && this._runAction(this._steps[o], s, this.duration), this._runAction(this._steps[o], 0, n, !0)) : this._runAction(this._steps[o], s, n)); else if ("step" == this._steps[o].type && u == o) {
                    var a = this._steps[u];
...
!function (t) {
    ...
    !function (e) {
        ...
        var h = function (e) {
            ...
            __extends(i, e);
            var s = __define, h = i, p = h.prototype;
        ...
        var p = function (t) {
            ...
            __extends(e, t);
            var n = __define, i = e, s = i.prototype;
